...
public enum VoidMessages {
    ...
    FIERCE_WARRIOR("You see a strong warrior, renown for his raw strength in combat", "It seems to have noticed you", new String[]{"Leave immediately", "Demand its services", "Contact it", "Reach out to it", "Let it contact you"}, Arrays.asList(
            player -> player.sendMessage(ChatColor.GREEN + "You left before anything could happen"), player -> {
                ...
                player.sendMessage(ChatColor.GREEN + "The being blasses you with part of its vitality");
